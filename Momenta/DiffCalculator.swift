...
//  humble
//
//  Created by Jonathon Fishman on 2/13/18.
...
struct ReloadableSection<N: Equatable>: Equatable {
    var key: String // unique identifier for the items
    var value: [ReloadableCell<N>] // cell items
    var index: Int // current position of this item in data array
